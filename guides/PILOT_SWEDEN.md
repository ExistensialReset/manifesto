...
Life Quality (Livskvalitet) has priority over:
- Productivity
- Optimization
- Institutional convenience
- Economic throughput

If people survive but do not live well, the system is misaligned.

---

### Non-Membership Clause
Flow is **not** a movement, organization, ideology, or membership system.
...
- No membership lists
- No dues
- No loyalty requirements
- No permanence obligation
...
If it starts to feel like obligation, it is no longer Flow.
...
## 1. WHY SWEDEN? (CONTEXT ANALYSIS)

Sweden is an ideal testing ground for Flow Nodes due to a unique paradox:

- **High Mammon-Efficiency:**  
  Extreme digitalization (BankID, Swish), high taxes, strong bureaucratic control, and institutional conformity demands.

- **High Latent Flow-Potential:**  
  *Allemansrätten*, high interpersonal trust, strong safety nets (on paper), and a long tradition of *Folkbildning* (self-education).

**Mission:**  
We do not fight “The System” (Systemet).  
We **use it as scaffolding** to build Existential Sovereignty.
...
### 2.2 Folkbildning = State-Funded Flow Infrastructure
...
**Result:**  
The state unknowingly funds the infrastructure of sovereignty.

---

### 2.3 Hyresgästföreningen = Baseline Defense
...
## 3. NAVIGATING BUREAUCRACY (ADMINISTRATIVE REALITY)

**Primary Threat:** Administrative Violence  
(Systemic harm through forms, language, delays, and misclassification)

---

### 3.1 The Ombud Strategy (Fullmakt)
...
## 5. PRACTICAL EXAMPLE: PILOT GÖTEBORG

**Scenario:**  
A Flow Circle in Majorna / Bergsjön / Hisingen.

1. **Baseline:**  
   Shared food planning → bulk staples → meals ≈ 15 SEK

2. **Resilience Mapping:**  
   One car, one drill, one sewing skill → communal assets

3. **Sanctuary:**  
   Weekly walks at Delsjön  
   No phones. No agenda.

4. **Infrastructure:**  
   Register as Studiecirkel via ABF → free meeting room

**Status:**  
They live inside Mammon.  
They do not obey it.
