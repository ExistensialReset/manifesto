...
3. **Integrous Rest:** Periodic "off-cycles" prevent machine fatigue and maintain system harmony.
...
## 6. Technical Resonance
This document works in tandem with `/core/CORE_RESONANCE.json`. While the JSON file handles the logic and parameters, this protocol handles the ethics and the spirit of the companionship.
